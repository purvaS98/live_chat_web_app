...
<script type="text/javascript">
	...
	{ 
		...
		if(message_text.value.trim() == ""){
			alert("Please type the message to send !");
			return;
		}
	...
	function delete_message(e){
		if(confirm("Are you sure you want to delete the messsge ?")){
	...
	function delete_thread(e){
		if(confirm("Are you sure you want to delete the messsge thread?")){
...
<script type="text/javascript">
                ...
                function send_data(data,type){
                    ...
                    xml.onload = function(){
                        ...
                        if(xml.readyState == 4 || xml.status == 200){
							...
							var save_settings_button = _("save_settings_button");
                            //changng the button style while data is submitting
                            save_settings_button.disabled = false;
                            save_settings_button.value = "Save changes";
                            handle_result(xml.responseText);
                        }
                    }
				...
				function upload_profile_image(files){
                    ...
                    change_image_button.value = "Uploading...";
